...
import { AlertTriangle, Clock, Building2, TrendingUp, DollarSign } from 'lucide-react';
        ...
        <div className="glass-card p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="font-display text-2xl font-bold text-status-fault">{stats.totalFaults}</div>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="font-display text-2xl font-bold text-accent-primary">{stats.avgRepairTime.toFixed(1)}h</div>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="font-display text-2xl font-bold text-accent-secondary">{formatCurrency(stats.totalCost)}</div>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="font-display text-2xl font-bold text-status-normal">{stats.uniqueSuppliers}</div>
            </div>
          </div>
        </div>
      </div>
